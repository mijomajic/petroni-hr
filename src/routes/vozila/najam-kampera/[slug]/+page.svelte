...
<div class="section">
  <div class="container-x">
    {#if vehicle}
      ...
      <h1 class="text-[26px] md:text-[32px] font-bold text-[#2b2b2b] mb-8 leading-tight">{vehicle.name}</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <a href="/kontakt" class="btn btn-primary px-7 py-3.5">{$locale === 'hr' ? 'Kontaktirajte nas' : 'Contact us'}</a>
          </div>
        </div>
          ...
          <div class="card p-6">
            ...
            {#if vehicle.price_per_day}
              <div class="flex items-center justify-between py-2.5 border-b border-[#f0f1f3]">
                ...
                <span class="text-[13px] font-semibold" style="color:#b5890a">{vehicle.price_per_day} €/{$locale === 'hr' ? 'dan' : 'day'}</span>
              </div>
            {/if}
            {#if vehicle.sale_price}
              <div class="flex items-center justify-between py-2.5">
                ...
                <span class="text-[13px] font-semibold" style="color:#b5890a">{vehicle.sale_price.toLocaleString('hr-HR')} €</span>
              </div>
            {/if}
          </div>
        </aside>
