    ...
    {:else}
      <div class="overflow-x-auto">
              ...
              <tr style="border-bottom: 1px solid #f0f1f3">
                <td class="px-4 py-3">
                  <div class="flex items-center gap-3">
                    ...
                    {/if}
                    <span class="font-medium text-[#2b2b2b]">{v.name}</span>
                  </div>
                </td>
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center gap-2">
                    <a href="/admin/vozila/{v.id}" class="px-3 py-1 rounded-lg text-xs font-bold transition-colors hover:bg-[#f1f2f4]" style="color: #7a7f86; border: 1px solid #e7e8eb">Uredi</a>
        ...
        {#if vehicles.length === 0}
          <p class="p-8 text-center text-sm" style="color: #7a7f86">Nema vozila. <a href="/admin/vozila/novo" class="underline" style="color: #F5C518">Dodajte prvo vozilo.</a></p>
        {/if}
      </div>
    {/if}
  </div>
